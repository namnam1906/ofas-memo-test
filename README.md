...
> ค่าเริ่มต้นคือ `claude-sonnet-5` — คุ้มต้นทุนกว่า `claude-opus-5` (รุ่นความสามารถสูงสุดของ Anthropic) ราวๆ
> 2.5 เท่า โดยคุณภาพยังเหมาะกับงานร่างเอกสารแบบนี้ ถ้าต้องการความแม่นยำสูงสุดไม่ว่าจะเสียค่าใช้จ่ายเท่าไหร่
> เปลี่ยนกลับเป็น `claude-opus-5` ได้ ส่วน `gemini-2.5-flash` เป็นค่าเริ่มต้นฝั่ง Gemini — ชื่อรุ่นของ Gemini
